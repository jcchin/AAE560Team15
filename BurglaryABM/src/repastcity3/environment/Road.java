...
public class Road implements FixedGeography, Identified {
	...
	private String ROADCAT_DS; // To be used by ShapefileLoader, should contain string of words separated by spaces
	...
	/**
	 * This should be called once this Road object has been created to perform some extra initialization (e.g. setting
	 * the accessibility methods available to this Road).
	 * 
	 * @throws NoIdentifierException
	 */
	public void initialize() throws NoIdentifierException {
		...
		if (this.ROADCAT_DS != null) { // Could be null because not using accessibility in GRID environment for example
			this.accessibility = new ArrayList<String>();
			for (String word : this.ROADCAT_DS.split(" ")) {
	 ...
	 */
	public void setROADCAT_DS(String ROADCAT_DS) {
		this.ROADCAT_DS = ROADCAT_DS;
	}
