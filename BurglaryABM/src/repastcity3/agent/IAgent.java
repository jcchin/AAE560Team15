...
public interface IAgent {
	...
	/**
	 * Set the agents money increment level based on census income data.
	 */
	void setMoneyIncrementLevel();
	...
	void setJurisdiction(Building b);
	...
	void addTravelDistance(double distTravelled);
